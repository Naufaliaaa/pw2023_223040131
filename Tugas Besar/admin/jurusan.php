<?php 
  ...
  $jurusan = mysqli_query($DB_CONNECTION, $sql);
    ...
    <div class="mdb-page-content page-intro bg-light">
      <div class="container-fluid py-3">
        <div class="row">
          ...
          <div class="col-2 float-right mb-2 mr-3">
            <a href="tambah-jurusan.php" class="btn btn-primary">Tambah</a>
          </div>
              ...
              <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><img src="../img/jurusan/<?php echo $data['gambar']; ?>" class="img-fluid" width="50" height="50"></td>
                        <td><?php echo $data['nama']; ?></td>
                        <td><?php echo $data['deskripsi']; ?></td>
                        <td><?php echo $data['prospek_kerja']; ?></td>
                        <td class="text-center">
                            <a href="edit-jurusan.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-sm">Ubah</a>
                            <a href="hapus-jurusan.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm confirm">Hapus</a>
                        </td>
                    </tr>
                <?php
                    }
