...
if(isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO jurusan(nama, deskripsi, prospek_kerja, gambar) VALUE('{$nama}', '{$deskripsi}', '{$prospek_kerja}','{$fileFoto}')";
  ...
  echo "<meta http-equiv='refresh' content='0; url=tambah-jurusan.php'>";
          ...
          <div class="col-10 m-auto">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea type="text" rows="3" name="prospek_kerja" class="form-control" id="exampleInputPassword1" placeholder="Prospek Kerja"></textarea>
                </div>
